      ...
      <div className="max-w-7xl mx-auto">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <p className="text-gray-600">
                  <strong>Property:</strong> {tenancy.address || tenancy.property_address}
                </p>
                <p className="text-gray-600">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-bold text-indigo-600">28 Days</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow overflow-hidden">
          <div className="px-6 py-4 border-b border-gray-200">
            ...
            <p className="text-sm text-gray-600 mt-1">
              Showing {payments.length} payments (28-day cycle)
            </p>
          </div>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ul className="text-sm text-blue-800 space-y-1">
            <li>• Payments are due every 28 days from the tenancy start date</li>
